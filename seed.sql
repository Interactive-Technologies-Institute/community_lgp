...
drop table if exists public.howtos_useful;
drop table if exists public.events;
drop table if exists public.events_interested;
...
drop function if exists get_event_interest_count;
drop function if exists get_howto_count;
-- Create types
