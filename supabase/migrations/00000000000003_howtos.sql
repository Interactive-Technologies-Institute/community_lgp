...
create function public.handle_how_to_moderation_insert() returns trigger language plpgsql security definer as $$ begin
...
create function handle_how_to_moderation_update() returns trigger language plpgsql security definer as $$ begin
...
from public.howtos h
	join public.howtos_moderation m on h.id = m.howto_id;
