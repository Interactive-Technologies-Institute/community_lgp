<script lang="ts">
	...
	import CommentDisplay from '@/components/dictionary/sign/CommentDisplay.svelte';
	import CommentForm from '@/components/dictionary/sign/comment-form.svelte';
	import DistrictMap from '@/components/dictionary/sign/DistrictMap.svelte';

	import FavoriteButton from '@/components/dictionary/sign/favorite-button.svelte';
	import SignRatingButton from '@/components/dictionary/sign/SignRatingButton.svelte';
		...
		<section class="rounded-b-[2rem] bg-brand-surface shadow-md">
			<div class="container mx-auto p-4">
				...
				<div class="mt-2 flex flex-col gap-5 lg:mt-6 lg:flex-row-reverse lg:gap-10">
					<!-- Sign Card -->
					<Card.Root class="w-full lg:w-2/3 rounded-2xl border-brand-border bg-brand-white p-4 shadow-none">
