								...
								<div class="flex flex-col">
                                    ...
                                    {#if sign.user}
                                        <div class="flex items-center gap-3 pt-3">
                                            ...
                                            <span class="text-sm text-gray-600">Número de comentários: {sign.comment_count}</span>
                                        </div>
                                    {/if}
								</div>
							</Card.Content>
                            ...
                            <Card.Content class="flex items-center justify-center p-3 min-h-[300px]">
                                <div class="flex flex-col items-center justify-center text-center space-y-4">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <p class="text-sm text-gray-600">Explore todas as propostas mais discutidas na comunidade</p>
                                    </div>
