...
<Dialog.Root bind:open={openApproveDialog}>
	<Dialog.Content class="sm:max-w-[425px]">
		<Dialog.Header>
			...
			<Dialog.Description>Are you sure you want to approve this Event?</Dialog.Description>
		</Dialog.Header>
...
<Dialog.Root bind:open={openRejectDialog}>
	<Dialog.Content class="sm:max-w-[425px]">
		<Dialog.Header>
			...
			<Dialog.Description>Are you sure you want to reject this Event?</Dialog.Description>
		</Dialog.Header>
		<form method="POST" use:enhance>
			<input type="hidden" name="refId" value={id} />
...
<Dialog.Root bind:open={openRequestChangesDialog}>
	<Dialog.Content class="sm:max-w-[425px]">
		<Dialog.Header>
			...
			<Dialog.Description
				>Are you sure you want to request changes for this Event?</Dialog.Description
			>
		</Dialog.Header>
		<form method="POST" use:enhance>
			<input type="hidden" name="refId" value={id} />
